        ...
        <div className="grid md:grid-cols-5 gap-12 items-center">
          ...
          <div className="md:col-span-3">
            ...
            <p className="text-brand-beige/80 mb-4 leading-relaxed">
              Olá! Sou Jairo Koning, um Engenheiro de Software apaixonado por criar soluções digitais que são tanto funcionais quanto visualmente atraentes. Com mais de 7 anos de experiência em desenvolvimento web, eu transformo ideias complexas em aplicações robustas e intuitivas.
            </p>
            <p className="text-brand-beige/80 mb-4 leading-relaxed">
